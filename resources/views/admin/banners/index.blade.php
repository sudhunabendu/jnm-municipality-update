            ...
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <h5 class="card-title">Banner List <span class="text-muted fw-normal ms-2">(834)</span>
                                </h5>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($banners as $banner)
                                    <tr>
                                        ...
                                        <td>{{ $banner->title }}</td>
                                        @php
                                            $created_at = \Carbon\Carbon::parse($banner->created_at);
                                            $updated_at = \Carbon\Carbon::parse($banner->updated_at);
                                        @endphp
