                ...
                <div class="card-body">
                    <form action="{{ route('admin.councillors.create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="first_name" name="first_name" type="text"
                                        ...
                                        placeholder="Enter News & Event first_name" value="{{ old('first_name') }}">
                                    @error('first_name')
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="last_name" name="last_name" type="text"
                                        ...
                                        placeholder="Enter News & Event last_name" value="{{ old('last_name') }}">
                                    @error('last_name')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="email" name="email" type="text"
                                        ...
                                        placeholder="Enter News & Event email" value="{{ old('email') }}">
                                    @error('email')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="phone" name="phone" type="text"
                                        ...
                                        placeholder="Councillor phone" value="{{ old('phone') }}">
                                    @error('phone')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label for="word_number">Word Number <span style="color:red">*</span></label>
