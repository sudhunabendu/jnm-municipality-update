...
<head>
        ...
        <meta charset="utf-8" />
        <title>Login | JMM</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
        <meta content="Themesbrand" name="author" />
        <!-- App favicon -->
        <link href={{asset("public/dason/images/favicon.ico")}} rel="shortcut icon">

        <!-- preloader css -->
        <link href={{asset("public/dason/css/preloader.min.css")}} type="text/css" rel="stylesheet"/>

        <!-- Bootstrap Css -->
        <link href={{asset("public/dason/css/bootstrap.min.css")}} id="bootstrap-style" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        ...
        <style>
            .auth-bg{
                background-image: url(https://plus.unsplash.com/premium_photo-1680806491608-af096f1fc916?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);
            }
        </style>
    ...
    <!-- <body data-layout="horizontal"> -->
            ...
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-xxl-3 col-lg-4 col-md-5">
                        <div class="auth-full-page-content d-flex py-sm-4 px-sm-5 p-4">
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src={{asset("public/dason/images/logo-sm.svg")}} alt="" height="28"> <span class="logo-txt">JMM</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Welcome Back !</h5>
                                            <p class="text-muted mt-2">Sign in to continue dashboard</p>
                                        </div>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="form-check font-size-15">
                                                        <input class="form-check-input" type="checkbox" id="remember-check" name="remember" value="true">
                                        ...
                                        <div id="reviewcarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                            <div class="carousel-indicators auth-carousel carousel-indicators-rounded justify-content-center mb-0">
                                                <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                                    <img src={{asset("public/dason/images/users/avatar-1.jpg")}} class="avatar-md img-fluid rounded-circle d-block" alt="...">
                                                </button>
                                                <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="1" aria-label="Slide 2">
                                                    <img src={{asset("public/dason/images/users/avatar-2.jpg")}} class="avatar-md img-fluid rounded-circle d-block" alt="...">
                                                </button>
                                                <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                                                    <img src={{asset("public/dason/images/users/avatar-3.jpg")}} class="avatar-md img-fluid rounded-circle d-block" alt="...">
                                                </button>
                                            </div>
        ...
        <script src={{asset("public/dason/js/pages/pass-addon.init.js")}}></script>

        <script src={{asset("public/dason/js/pages/feather-icon.init.js")}}></script>
