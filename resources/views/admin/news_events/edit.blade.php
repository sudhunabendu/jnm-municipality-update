    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Update Banner</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Jnmunicipality</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <img src="{{URL::asset('public/images/banner_images').'/'.$image}}" alt="" width="30%"
                                        height="51px">
                                    @endforeach
                                    @endif
