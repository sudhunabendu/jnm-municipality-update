...
if ($("#contact-form").length) {
    $("#contact-form").validate({
        ...
        errorElement: 'div',
        errorClass: 'error text-danger small mt-1', // 👈 Add danger classes
        highlight: function (element) {
            $(element).closest('.input-box').addClass('has-error');
            $(element).addClass('is-invalid'); // Bootstrap invalid field style
        },
        unhighlight: function (element) {
            $(element).closest('.input-box').removeClass('has-error');
        ...
        submitHandler: function (form) {
            ...
            form_btn.before('<div id="form-result" class="alert d-none" role="alert"></div>');
            ...
            $form.ajaxSubmit({
                ...
                success: function (response) {
                    ...
                    $formResult.removeClass('d-none').fadeIn('slow');
                    setTimeout(function () {
