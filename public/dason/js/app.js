! function(n) {
    "use strict";
    var e, t, a, r, o = localStorage.getItem("Dason-language"),
        d = "en";

    function i(t) {
        document.getElementById("header-lang-img") && ("en" == t ? document.getElementById("header-lang-img").src = "assets/images/flags/us.jpg" : "sp" == t ? document.getElementById("header-lang-img").src = "assets/images/flags/spain.jpg" : "gr" == t ? document.getElementById("header-lang-img").src = "assets/images/flags/germany.jpg" : "it" == t ? document.getElementById("header-lang-img").src = "assets/images/flags/italy.jpg" : "ru" == t && (document.getElementById("header-lang-img").src = "assets/images/flags/russia.jpg"), localStorage.setItem("Dason-language", t), null == (o = localStorage.getItem("Dason-language")) && i(d), n.getJSON("assets/lang/" + o + ".json", function(t) {
    ...
    n("#side-menu").metisMenu(), s(), e = document.body.getAttribute("data-sidebar-size"), n(window).on("load", function() {
        ...
        }), o && "null" != o && o !== d && i(o), n(".language").on("click", function(t) {
            i(n(this).attr("data-lang"))
        }), feather.replace(), n(window).on("load", function() {
            n("#status").fadeOut(), n("#preloader").delay(350).fadeOut("slow")
        }), a = document.getElementsByTagName("html")[0], r = document.getElementsByTagName("body")[0], n(".right-bar-toggle").on("click", function(t) {
            n("body").toggleClass("right-bar-enabled")
        }), n("#mode-setting-btn").on("click", function(t) {
            a.hasAttribute("data-bs-theme") && "dark" == a.getAttribute("data-bs-theme") ? ("dark" == localStorage.getItem("data-sidebar") && "horizontal" !== r.getAttribute("data-layout") && document.body.setAttribute("data-sidebar", "dark"), "dark" == localStorage.getItem("data-topbar") && "horizontal" !== r.getAttribute("data-layout") && (document.body.setAttribute("data-sidebar", "light"), document.body.setAttribute("data-topbar", "dark")), a.setAttribute("data-bs-theme", "light"), "dark" !== localStorage.getItem("data-topbar") && (document.body.setAttribute("data-topbar", "light"), c("topbar-color-light")), "brand" == localStorage.getItem("data-sidebar") && document.body.setAttribute("data-sidebar", "brand"), localStorage.getItem("data-sidebar") || localStorage.getItem("data-topbar") || document.body.removeAttribute("data-sidebar")) : ("dark" == localStorage.getItem("data-sidebar") && document.body.setAttribute("data-sidebar", "dark"), a.setAttribute("data-bs-theme", "dark"), document.body.setAttribute("data-topbar", "dark"), document.body.setAttribute("data-sidebar", "dark"))
        ...
        }), r.hasAttribute("data-layout") && "horizontal" == r.getAttribute("data-layout") ? (c("layout-horizontal"), n(".sidebar-setting").hide()) : c("layout-vertical"), document.documentElement.hasAttribute("data-theme-mode") && "purple" == document.documentElement.getAttribute("data-theme-mode") ? c("theme-purple") : document.documentElement.hasAttribute("data-theme-mode") && "red" == document.documentElement.getAttribute("data-theme-mode") ? c("theme-red") : c("theme-default"), a.hasAttribute("data-bs-theme") && "dark" == a.getAttribute("data-bs-theme") ? c("layout-mode-dark") : c("layout-mode-light"), r.hasAttribute("data-layout-size") && "boxed" == r.getAttribute("data-layout-size") ? c("layout-width-boxed") : c("layout-width-fuild"), r.hasAttribute("data-layout-scrollable") && "true" == r.getAttribute("data-layout-scrollable") ? c("layout-position-scrollable") : c("layout-position-fixed"), "light" != r.getAttribute("data-topbar") && "dark" == r.getAttribute("data-topbar") ? c("topbar-color-dark") : c("topbar-color-light"), r.hasAttribute("data-sidebar-size") && "sm" == r.getAttribute("data-sidebar-size") ? c("sidebar-size-small") : r.hasAttribute("data-sidebar-size") && "md" == r.getAttribute("data-sidebar-size") ? c("sidebar-size-compact") : c("sidebar-size-default"), r.hasAttribute("data-sidebar") && "brand" == r.getAttribute("data-sidebar") ? c("sidebar-color-brand") : r.hasAttribute("data-sidebar") && "dark" == r.getAttribute("data-sidebar") ? c("sidebar-color-dark") : c("sidebar-color-light"), document.getElementsByTagName("html")[0].hasAttribute("dir") && "rtl" == document.getElementsByTagName("html")[0].getAttribute("dir") ? c("layout-direction-rtl") : c("layout-direction-ltr"), n("input[name='layout']").on("change", function() {
            window.location.href = "vertical" == n(this).val() ? "index.html" : "layouts-horizontal.html"
        }), n("input[name='layout-mode']").on("change", function() {
            "light" == n(this).val() ? (a.setAttribute("data-bs-theme", "light"), document.body.setAttribute("data-topbar", "light"), document.body.setAttribute("data-sidebar", "light"), r.hasAttribute("data-layout") && "horizontal" == r.getAttribute("data-layout") || document.body.setAttribute("data-sidebar", "light"), c("topbar-color-light"), c("sidebar-color-light")) : (a.setAttribute("data-bs-theme", "dark"), document.body.setAttribute("data-topbar", "dark"), document.body.setAttribute("data-sidebar", "dark"), r.hasAttribute("data-layout") && "horizontal" == r.getAttribute("data-layout") || document.body.setAttribute("data-sidebar", "dark"), c("sidebar-color-dark"))
